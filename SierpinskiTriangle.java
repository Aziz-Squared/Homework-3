...
public class SierpinskiTriangle extends AbstractShape {
	...
	SierpinskiTriangle(Graphics g,  double ax, double ay, double bx, double by, double cx,
			double cy, int maxendLevel,int  slevel) {
		super(maxendLevel, slevel);
		Graphics2D g2 = (Graphics2D) g;
		g2.setStroke(new BasicStroke(3));
		g2.setColor(Color.GREEN);				
		maxLevel = maxendLevel;
	...
	/**
	 * Draw a Sierpinski Trinagle with a given recursion level, with vertices at the
