...
public class FractalDisplay extends JPanel implements MouseListener, ActionListener, ChangeListener {
	...
	public void actionPerformed(ActionEvent e) {		
		if (e.getSource().getClass() == JRadioButton.class) {
			...
			if (shape != null) {
				...
				if (!success) {
					JOptionPane.showMessageDialog(this, "Can't add another level", "Message",					        JOptionPane.WARNING_MESSAGE);
				} else {
					level++;
				}
				drawShape(which);
	...
	private void drawShape(int which ) {
		...
		case SIERPINSKI_TRIANGLE:
			...
			shape = new SierpinskiTriangle(getGraphics(), WIDTH/2, 10, 20, HEIGHT-200, WIDTH-20, HEIGHT-200, 10, level);
			//shape.addLevel();
		...
		case MY_SHAPE:
			...
			shape = new KochCurve(getGraphics(), HEIGHT, WIDTH,10, level);
			break;
		}
